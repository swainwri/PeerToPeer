...
// Pop Up Styles
public enum SCLAlertViewStyle: Sendable {
...
open class SCLAlertViewResponder {
    ...
    @MainActor open func setTitle(_ title: String) {
        self.alertview.labelTitle.text = title
    }
    
    @MainActor open func setSubTitle(_ subTitle: String) {
        self.alertview.viewText.text = subTitle
    }
    
    @MainActor open func setAttributedSubTitle(_ subTitle: NSAttributedString) {
    ...
    @MainActor open func setDismissBlock(_ dismissBlock: @escaping DismissBlock) {
...
open class SCLAlertView: UIViewController {
	...
	let kTitleMinimumScaleFactor: CGFloat
        ...
        let contentViewAlignment: NSTextAlignment  // added Steve Wainwright 4/10/2020
    ...
    fileprivate func setup() {
        ...
        viewText.textAlignment = appearance.contentViewAlignment //  added SW  4/10/2020 .center
...
//                }
    ...
    open func isShowing() -> Bool {
        if let windowScene = UIApplication.shared.connectedScenes.first as? UIWindowScene,
           let subviews = windowScene/*UIApplication.shared*/.keyWindow?.subviews {
...
class SCLAlertViewStyleKit {
    
    // Cache
    struct Cache {
        var imageOfCheckmark: UIImage?
        var checkmarkTargets: [AnyObject]?
        var imageOfCross: UIImage?
        var crossTargets: [AnyObject]?
        var imageOfNotice: UIImage?
        var noticeTargets: [AnyObject]?
        var imageOfWarning: UIImage?
        var warningTargets: [AnyObject]?
        var imageOfInfo: UIImage?
        var infoTargets: [AnyObject]?
        var imageOfEdit: UIImage?
        var editTargets: [AnyObject]?
        var imageOfQuestion: UIImage?
        var questionTargets: [AnyObject]?
    }
